...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/webtest-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8315&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/webtest-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `webtest` can be installed with:

```
conda install webtest
```

It is possible to list all of the versions of `webtest` available on your platform with:
